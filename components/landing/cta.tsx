...
export function CtaSection() {
  ...
  return (
    <section className="px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
      <div className="mx-auto max-w-4xl rounded-[2rem] bg-landing-peach px-6 py-14 text-center sm:px-12">
        <h2 className="text-2xl font-extrabold text-slate-900 sm:text-3xl">
          {t.cta.title}{" "}
          <span className="text-landing-orange">{t.cta.titleHighlight}</span>
        </h2>
        <p className="mx-auto mt-3 max-w-lg text-slate-600">{t.cta.subtitle}</p>
        <button
          type="button"
